...
class _GuessPageState extends State<Webpage> {
  var _num = '';
    ...
    return Padding(
      ...
      child: InkWell(
          ...
          child: Container(
            ...
            child: Image.asset('assets/images/close.png', width: 25.0, color: Colors.purple),
          )
      ),
    );
  }
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                Image.asset('assets/images/logo.png', width: 90.0),
                SizedBox(width: 10.0),
                Column(
                  children: [
                    Text('GUESS',
